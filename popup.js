document.addEventListener("DOMContentLoaded", () => {
    ...
    function showPasteScreen() {
        container.innerHTML = `
            ...
            <section class="intro">
                ...
                <div
                    id="characterCounter"
                    style="margin-top:8px;font-size:12px;opacity:.75;text-align:right;"
                >
                    0 characters
                </div>
                ...
                <div
                    ...
                    style="display:none;margin-top:12px;padding:10px;border-radius:8px;background:#fff3cd;color:#664d03;font-size:13px;"
                ></div>
            </section>
        ...
        setTimeout(() => {
            try {
                ...
                container.innerHTML = `
                    ...
                    <section class="intro">
                        <p>
                            Something went wrong while analyzing the job offer.
                            Please try again.
                        </p>
                    </section>
                ...
                document.getElementById("retryAnalysis").onclick = () => {
                    showPasteScreen();
                };
            }
        }, 1800);
    ...
    function showResultScreen(result) {
        container.innerHTML = `
            ...
            <section class="intro">
                <h2>${escapeHTML(result.score)}/100</h2>
                ...
                <p>
                    ${escapeHTML(result.warningCount)} potential warning sign(s) detected.
                </p>
            </section>
        ...
        document.getElementById("viewAnalysis").onclick = () => {
            showFullAnalysis(result);
        };

        document.getElementById("analyzeAnother").onclick = () => {
            showPasteScreen();
        };
    }
    ...
    function showFullAnalysis(result) {
        ...
        if (!Array.isArray(result.findings) || result.findings.length === 0) {
            findingsHTML = `
                <p>
                    No significant warning signs were detected based on the
                    current explainable rules.
                </p>
            `;
        } else {
        ...
        container.innerHTML = `
            ...
            <section class="privacy">
                ...
                <p>
                    Fake Job Shield identifies potential warning signs using
                    explainable rules. The analysis does not determine whether a
                    job offer is genuine or fraudulent. Always independently
                    verify recruiters, employers, interview processes, payment
                    requests, and company information before making decisions.
                </p>
            </section>
